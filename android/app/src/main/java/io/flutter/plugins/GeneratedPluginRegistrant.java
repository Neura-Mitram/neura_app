...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.byshiladityamallick.micstream.MicStreamPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin mic_stream, com.byshiladityamallick.micstream.MicStreamPlugin", e);
    }
    try {
